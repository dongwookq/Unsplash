...
class ListPhotosViewController: UICollectionViewController {
    private let cellReuseIdentifier: String = "testCell"
    ...
    private func configureCell(_ cell: TestCollectionViewCell,
...
//                    let placeHolderImage: UIImage? = UIImage(named: "button_star")
//                    cell.imageView.image = placeHolderImage
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell: TestCollectionViewCell = cell as? TestCollectionViewCell else {
            return
        }
